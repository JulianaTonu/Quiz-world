...
const Home = () => {
    ...
    return (
        <div className='container bg-white '>
            ...
            <p>There are some important question about 
            Four different topics.They are React, JavaScript, Css, Git.You can develop and judge your skill by participate this quiz.Hope you will enjoy it.Good Luck.</p>
            </div>
            </div>
